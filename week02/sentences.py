...
def make_sentence(quantity, tense):
    ...
    sentence = f"{determiner.capitalize()} {noun} {prepositional_phrase_one} {verb} {prepositional_phrase_two}."
    return sentence
...
def get_adjective():
    ...
    adjectives = ["sad", "happy", "angry", "livid", "ecstatic", "belligerent", "prickly", "fierce"]
